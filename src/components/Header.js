...
export default () => {
    return (
        <header className="flex-shrink-0 relative h-12 flex items-center border-b border-gray-200">
            <div className="left-0 px-4 border-r border-gray-200 w-80">
            ...
            <div className="hidden md:min-w-0 md:flex-1 md:flex md:items-center md:justify-between">
                    ...
                    <nav aria-label="Global" className="flex">
                        <ul className='flex justify-center'>
                            <li className='border-gray-200 border-b-4 hover:border-orange-700 h-12 py-2.5 text-gray-100 hover:text-gray-50'>
                                <Link to="/" className="text-sm font-medium border-r border-gray-200 h-12 px-4 py-3.5">_hello</Link>
                            </li>
                            <li className='border-gray-200 border-b-4 hover:border-orange-700 h-12 py-2.5 text-gray-100 hover:text-gray-50'>
                ...
                <div className="ml-10 flex-shrink-0 flex items-center space-x-10">
                    <nav aria-label="Global" className="flex">
                        ...
                        {/* <Link to="/contact" className="text-sm font-medium text-gray-100 hover:text-gray-50 border-l border-gray-200 py-3 px-4">_contact</Link> */}
                    </nav>
                </div>
            </div>
        </header>
